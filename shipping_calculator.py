"""
Shipping Calculator
Calculates shipping costs and delivery estimates.
"""
...
def main():
    ...
    try:
        ...
        print(f"  Shipping Type: {result['shipping_type'].capitalize()}")
        print(f"  Distance Zone: {result['distance_zone'].capitalize()}")
